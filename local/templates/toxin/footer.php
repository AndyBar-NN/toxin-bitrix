...
<footer class="footer">
    <div class="container_main">
        <div class="footer__col">
            <div class="col1">
                ...
                <p class="col1__text">Бронирование номеров в лучшем отеле 2019 года по версии ассоциации «Отельные
                    взгляды»</p>
            </div>
            <div class="col2">
            ...
            <div class="col5">
                ...
                <form class="col5__input">
                    ...
                    <button type="submit" class="col5__input--submit"><img
                                src="<?= SITE_TEMPLATE_PATH ?>/img/icons/arrow_right.svg" alt=""></button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="copyright">
        <div class="container copyright__block">
            ...
            <div class="social">
<!--                <a href="#" class="social__link"><img src="--><?//= SITE_TEMPLATE_PATH ?><!--/img/icons/twiter.svg" alt=""></a>-->
<!--                <a href="#" class="social__link"><img src="--><?//= SITE_TEMPLATE_PATH ?><!--/img/icons/facebook.svg" alt=""></a>-->
<!--                <a href="#" class="social__link"><img src="--><?//= SITE_TEMPLATE_PATH ?><!--/img/icons/instagram.svg" alt=""></a>-->
            </div>
        </div>
    </div>
</footer>
