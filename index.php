                ...
                <form action="#" class="table__form">
                    ...
                    <div class="table__data">
                        <div class="table__arrival">
                            ...
                            <img src="<?=SITE_TEMPLATE_PATH?>/img/icons/arrow_down.svg" class="table__arrival--arrow" alt="">
                        </div>
                        <!-- /.table__arrival -->
                        <div class="table__departure">
                            ...
                            <img src="<?=SITE_TEMPLATE_PATH?>/img/icons/arrow_down.svg" class="table__departure--arrow" alt="">
                        </div>
                        <!-- /.table__departure -->
                    </div>
                    <!-- /.table__data -->
                    <div class="table__guest">
                        ...
                        <img src="<?=SITE_TEMPLATE_PATH?>/img/icons/arrow_down.svg" class="table__guest--arrow" alt="">
                    ...
                    <!-- /.table__guest -->
                    <a href="/rooms/" id="getRooms" class="search search__button">Подобрать номер<img src="<?=SITE_TEMPLATE_PATH?>/img/icons/arrow_white.svg"
                                                                                                      class="search__arrow" alt=""></a>
                </form>
                <!-- /.table__form -->
            </div>
            <!-- /.table -->
